...
https://github.com/BlackBeltTechnology/judo-meta-query/releases
...
https://app.wercker.com/BlackbeltTechnology/judo-meta-query/runs
...
To run code generation inside eclipse, run as MWE2 Workflow:
   hu.blackbelt.judo.meta.query.model project src/workflow/generateModel.mwe2
